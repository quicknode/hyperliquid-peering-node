...
The guide's reference host uses 16 dedicated vCPUs, 128 GiB RAM, and 2,340 GiB of local NVMe storage. Hyperliquid's upstream base specification lists 16 vCPUs, 128 GB RAM, and a 500 GB SSD, but 500 GB is not enough for sustained raw mempool retention. Quicknode has observed approximately 1.1 TB/day of raw mempool output, with higher short intervals. Activity varies, so measure your own growth and keep operational headroom.
